...
RUN apt-get -y update \
  ...
  && curl -sSL --header "Cookie: oraclelicense=accept-securebackup-cookie;" "http://download.oracle.com/otn-pub/java/jdk/${JAVA_VERSION}u${JAVA_UPDATE}-b${JAVA_BUILD}/e9e7ea248e2c4826b92b3f075a80e441/jdk-${JAVA_VERSION}u${JAVA_UPDATE}-linux-arm64-vfp-hflt.tar.gz" | tar -xz \
